...
$sql = "UPDATE tbl_216_aps SET country='$country', city='$city', streetNumber='$streetNumber', size='$size', howToGetIn='$howToGetIn', reservationDate='$reservationDate', startHour='$startHour', endHour='$endHour' WHERE id=$id";
